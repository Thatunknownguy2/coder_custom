...
func (q *fakeQuerier) GetWorkspaceAgentStartupLogsByID(_ context.Context, agentID uuid.UUID) (database.StartupScriptLog, error) {
	q.mutex.Lock()
	defer q.mutex.Unlock()
	...
	return database.StartupScriptLog{}, sql.ErrNoRows
}

func (q *fakeQuerier) InsertOrUpdateWorkspaceAgentStartupLogsByID(_ context.Context, arg database.InsertOrUpdateWorkspaceAgentStartupLogsByIDParams) error {
	if err := validateDatabaseType(arg); err != nil {
		return err
	}
